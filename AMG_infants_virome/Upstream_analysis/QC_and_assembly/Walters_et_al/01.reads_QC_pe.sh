...
# --- FILTERING HUMAN READS & LOW QUALITY READS SE ---
...
# --- FILTERING HUMAN READS & LOW QUALITY READS PE ---
...
# --- CORRECTING READ ERRORS IN SE READS ---
