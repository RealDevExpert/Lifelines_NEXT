#!/bin/bash
#SBATCH --job-name=readspe_QC
#SBATCH --error=readspe_QC.err
#SBATCH --output=readspe_QC.out
#SBATCH --mem=32gb
#SBATCH --time=4:59:00
...
spades.py \
        ...
        --pe1-1 ${TMPDIR}/${SAMPLE_ID}/clean_reads/${SAMPLE_ID}_dedup_paired_1.fastq.gz \
        --pe1-2 ${TMPDIR}/${SAMPLE_ID}/clean_reads/${SAMPLE_ID}_dedup_paired_2.fastq.gz \
        --pe1-s ${TMPDIR}/${SAMPLE_ID}/clean_reads/${SAMPLE_ID}_dedup_unmatched.fastq.gz \
